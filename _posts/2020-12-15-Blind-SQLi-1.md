...
We now have a working exploit, but it's kind of slow and very loud. Extracting multiple database entries will produce a lot of noise in the query log. I plan on doing a follow up post showing how to add a binary search function to reduce the amount of requests sent and our footprint in the logs.
